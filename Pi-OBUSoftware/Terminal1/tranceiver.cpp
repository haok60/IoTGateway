    ...
    QObject(parent)
{
    ...
    port = new QextSerialPort("ttyUSB1", settings, QextSerialPort::Polling);
...
//                    tmp += "\n";
                    ...
                    emit insertdata(mac,temp,"temperature");
